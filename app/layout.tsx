...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="id"><body className={`${jakarta.variable} ${sourceSerif.variable}`}>{children}<Analytics /></body></html>; }
